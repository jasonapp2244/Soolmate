...
import 'package:soolmate_ui/screen/person_streaming_screen/person_streaming_screen_view_model.dart';
import 'package:soolmate_ui/screen/person_streaming_screen/widgets/bottom_text_field.dart';
import 'package:soolmate_ui/screen/person_streaming_screen/widgets/comment_list_area.dart';
import 'package:soolmate_ui/screen/person_streaming_screen/widgets/person_top_bar_area.dart';
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<PersonStreamingScreenViewModel>.reactive(
      ...
      viewModelBuilder: () => PersonStreamingScreenViewModel(
          liveStreamUser: liveStreamUser, settingAppData: settingAppData),
