...
import 'package:soolmate_ui/common/drop_down_box.dart';
import 'package:soolmate_ui/generated/l10n.dart';
import 'package:soolmate_ui/screen/edit_profile_screen/edit_profile_screen_view_model.dart';
import 'package:soolmate_ui/screen/edit_profile_screen/widgets/interest_list.dart';
            ...
            children: [
              ...
              if (model.showDropdown)
                Positioned(
                    top: 45,
                    child: DropDownBox(
                        gender: model.gender, onChange: model.onGenderChange)),
            ],
          ),
                          ...
                          child: SizedBox(
                            ...
                            child: Center(
                              child: AnimatedDefaultTextStyle(
                                duration: const Duration(milliseconds: 200),
                                style: TextStyle(
                                  color: model.selectedGenderPref == 1
                                      ? ColorRes.white
                                      : ColorRes.darkOrange,
                                  fontSize: 13,
                          ...
                          child: SizedBox(
                            ...
                            child: Center(
                              child: AnimatedDefaultTextStyle(
                                duration: const Duration(milliseconds: 200),
                                style: TextStyle(
                                  color: model.selectedGenderPref == 3
                                      ? ColorRes.white
                                      : ColorRes.darkOrange,
                                  fontSize: 13,
                                  fontFamily: FontRes.bold,
                          ...
                          child: SizedBox(
                            ...
                            child: Center(
                              child: AnimatedDefaultTextStyle(
                                duration: const Duration(milliseconds: 200),
                                style: TextStyle(
                                  color: model.selectedGenderPref == 2
                                      ? ColorRes.white
                                      : ColorRes.darkOrange,
                                  fontSize: 13,
                                  fontFamily: FontRes.bold,
...
class RichTextCustom extends StatelessWidget {
  ...
  const RichTextCustom({super.key, required this.title, this.optional});
