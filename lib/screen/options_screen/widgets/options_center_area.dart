...
import 'package:soolmate_ui/screen/blocked_profiles_screen/blocked_profiles_screen.dart';
import 'package:soolmate_ui/screen/like_profiles_screen/like_profiles_screen.dart';
import 'package:soolmate_ui/screen/saved_profiles_screen/saved_profiles_screen.dart';
      ...
      children: [
        ...
        TopOptionCard(
            ...
            widget: Padding(
              ...
              child: Image.asset(AssetRes.sun,
                  height: 28, width: 28, color: ColorRes.lightOrange),
            )),
        Visibility(
