...
import 'package:soolmate_ui/common/dashboard_top_bar.dart';
import 'package:soolmate_ui/screen/profile_screen/profile_screen_view_model.dart';
import 'package:soolmate_ui/screen/profile_screen/widget/profile_images_area.dart';
          ...
          child: Column(
            children: [
              ...
              ProfileImageArea(
                ...
                onInstagramTap: () =>
                    model.onSocialBtnTap(model.userData?.instagram),
                onFacebookTap: () =>
                    model.onSocialBtnTap(model.userData?.facebook),
                onYoutubeTap: () =>
                    model.onSocialBtnTap(model.userData?.youtube),
