...
import 'package:soolmate_ui/screen/login_pwd_screen/login_pwd_screen_view_model.dart';
import 'package:soolmate_ui/screen/login_pwd_screen/widgets/password_card.dart';
...
class LoginPwdScreen extends StatelessWidget {
  ...
  const LoginPwdScreen({super.key, required this.email});
