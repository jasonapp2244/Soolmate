...
import 'package:soolmate_ui/screen/randoms_search_screen/randoms_search_screen_view_model.dart';
                ...
                children: [
                  SpinKitRipple(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return CircleAvatar(
                          backgroundColor:
                              ColorRes.grey21.withValues(alpha: 0.40));
                    },
                  ),
                  SpinKitRipple(
                    borderWidth: 50,
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return CircleAvatar(
                        backgroundColor:
                            ColorRes.grey21.withValues(alpha: 0.30),
                      );
                    },
                  ),
                  ClipOval(
                  ...
                  child: Stack(
                    children: [
                      ClipRRect(
                        ...
                        child: model.userData?.images == null ||
