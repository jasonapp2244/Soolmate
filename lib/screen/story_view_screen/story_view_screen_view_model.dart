...
import 'package:soolmate_ui/model/social/story/view_story.dart';
import 'package:soolmate_ui/model/user/registration_user.dart';
import 'package:soolmate_ui/service/pref_service.dart';
import 'package:soolmate_ui/story_view/controller/story_controller.dart';
import 'package:soolmate_ui/story_view/widgets/story_view.dart';
        ...
        completion: (response) {
          ...
          if (s != null) {
            if (userIndex < users.length) {
              ...
              int storyIndex =
                  stories.indexWhere((element) => element.id == s.id);
              if (storyIndex != -1) {
