...
import 'package:soolmate_ui/common/full_image_view_shimmer.dart';
import 'package:soolmate_ui/common/profile_detail_card.dart';
import 'package:soolmate_ui/common/social_icon.dart';
import 'package:soolmate_ui/common/top_story_line.dart';
import 'package:soolmate_ui/model/user/registration_user.dart';
import 'package:soolmate_ui/screen/explore_screen/explore_screen_view_model.dart';
import 'package:soolmate_ui/screen/explore_screen/widgets/suggest_photo_tap_view.dart';
import 'package:soolmate_ui/screen/explore_screen/widgets/swipe_right_view.dart';
      ...
      return Expanded(
          child: model.userList.isEmpty
              ...
              : CardSwiper(
                  ...
                  cardBuilder: (context, currentProfileIndex, percentThresholdX,
                      percentThresholdY) {
                    RegistrationUserData userData =
                        model.userList[currentProfileIndex];
                    ...
                    return Stack(
                      children: [
                          ...
                          Positioned(
                            ...
                            child: RotationTransition(
                              turns: AlwaysStoppedAnimation(
                                  !model.isLikeDisLikeStatus ? -15.9 : 15.9),
                              child: Image.asset(
                                model.isLikeDisLikeStatus == false
                                    ? AssetRes.icNope
                                    : AssetRes.icLike,
                                width: 150,
                                height: 150,
                        ...
                        SwipeRightView(
                            model: model, index: currentProfileIndex),
                        SuggestPhotoTapView(
                            model: model, index: currentProfileIndex)
                      ],
                    );
...
class BorderLineCustom extends StatelessWidget {
  const BorderLineCustom(
      {super.key, this.height = 10, this.color = Colors.black});
  final double height;
  final Color color;
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: InkWell(
                            onTap: () => widget.model.onImageLeftTap(
                                widget.pageController, currentImageIndex),
                            child: Container(
