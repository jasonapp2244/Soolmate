...
import 'package:soolmate_ui/screen/redeem_screen/redeem_screen_view_model.dart';
import 'package:soolmate_ui/screen/redeem_screen/widgets/center_area_redeem_screen.dart';
        ...
        return Scaffold(
          body: Column(
            children: [
              ...
              !model.isLoading
                  ? CenterAreaRedeemScreen(
                      redeemData: model.redeemData,
