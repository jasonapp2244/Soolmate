...
import 'package:soolmate_ui/screen/camera_preview_screen/camera_preview_screen_view_model.dart';
...
class CameraPreviewScreen extends StatelessWidget {
  ...
  const CameraPreviewScreen({super.key, required this.xFile, required this.type});
