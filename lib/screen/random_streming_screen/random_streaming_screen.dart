...
import 'package:soolmate_ui/screen/random_streming_screen/random_streaming_screen_view_model.dart';
import 'package:soolmate_ui/screen/random_streming_screen/widgets/bottom_text_field.dart';
import 'package:soolmate_ui/screen/random_streming_screen/widgets/comment_list_area.dart';
import 'package:soolmate_ui/screen/random_streming_screen/widgets/randon_stream_top_bar_area.dart';
...
class RandomStreamingScreen extends StatelessWidget {
  ...
  const RandomStreamingScreen(
      {super.key, this.userData, required this.liveStreamUser, this.settingData});
