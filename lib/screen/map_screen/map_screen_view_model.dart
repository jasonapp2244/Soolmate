...
import 'package:soolmate_ui/screen/map_screen/widgets/custom_marker.dart';
import 'package:soolmate_ui/screen/map_screen/widgets/user_pop_up.dart';
  ...
  Future<void> getUserByCoordinatesApiCall(
    ...
    ApiProvider()
      ...
      widgets = List.generate(
        ...
        (index) {
          String imageUrl =
              CommonFun.getProfileImage(images: userList[index].images);
          ...
          return CustomMarker(
              ...
              name: CommonUI.fullName(userList[index].fullname));
        },
      );
      for (int i = 0; i < userList.length; i++) {
        items.add(Place(
          userData: userList[i],
          latLng: LatLng(double.parse(userList[i].latitude ?? '0.0'),
              double.parse(userList[i].longitude ?? '0.0')),
        ));
      }
