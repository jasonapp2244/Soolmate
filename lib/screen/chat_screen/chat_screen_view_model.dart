...
import 'package:soolmate_ui/common/confirmation_dialog.dart';
import 'package:soolmate_ui/common/video_upload_dialog.dart';
...
import 'package:soolmate_ui/screen/bottom_diamond_shop/bottom_diamond_shop.dart';
import 'package:soolmate_ui/screen/chat_screen/widgets/image_video_send_sheet.dart';
import 'package:soolmate_ui/screen/chat_screen/widgets/image_view_page.dart';
import 'package:soolmate_ui/screen/chat_screen/widgets/item_selection_dialog_android.dart';
import 'package:soolmate_ui/screen/chat_screen/widgets/unblock_user_dialog.dart';
import 'package:soolmate_ui/screen/explore_screen/widgets/reverse_swipe_dialog.dart';
...
import 'package:soolmate_ui/screen/video_preview_screen/video_preview_screen.dart';
import 'package:soolmate_ui/screen/video_preview_screen/video_preview_screen_view_model.dart';
...
class ChatScreenViewModel extends BaseViewModel {
      ...
      isSelected
          ...
          : getChatMsgDialog(
              onContinueTap: (isSelected) =>
                  onPlusContinueClick(isSelected, type));
    } else {
      emptyDialog();
    }
  }
  ...
  Future<void> onVideoItemClick(ChatMessage? data) async {
    await Get.to(() =>
            VideoPreviewScreen(videoUrl: data?.video, type: VideoType.other))
        ?.then((value) {});
    SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(
