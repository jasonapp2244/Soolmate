...
import 'package:soolmate_ui/screen/dashboard/dashboard_screen.dart';
import 'package:soolmate_ui/screen/login_pwd_screen/login_pwd_screen.dart';
import 'package:soolmate_ui/screen/login_pwd_screen/widgets/forgot_password.dart';
import 'package:soolmate_ui/screen/register_screen/register_screen.dart';
import 'package:soolmate_ui/screen/select_hobbies_screen/select_hobbies_screen.dart';
import 'package:soolmate_ui/screen/select_photo_screen/select_photo_screen.dart';
import 'package:soolmate_ui/screen/starting_profile_screen/starting_profile_screen.dart';
...
class LoginDashboardScreenViewModel extends BaseViewModel {
  ...
  void init() {
    FirebaseNotificationManager.shared
        .getNotificationToken((token) => tokenId = token);
    getEmail();
  }
