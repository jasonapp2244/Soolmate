...
import 'package:soolmate_ui/model/chat_and_live_stream/add_live_stream_history.dart';
import 'package:soolmate_ui/model/chat_and_live_stream/agora.dart';
import 'package:soolmate_ui/model/chat_and_live_stream/apply_for_live.dart';
import 'package:soolmate_ui/model/chat_and_live_stream/fetch_live_stream_history.dart';
import 'package:soolmate_ui/model/fetch_redeem_request.dart';
import 'package:soolmate_ui/model/get_diamond_pack.dart';
import 'package:soolmate_ui/model/get_explore_screen.dart';
import 'package:soolmate_ui/model/get_interest.dart';
import 'package:soolmate_ui/model/map/fetch_user_coordinate.dart';
import 'package:soolmate_ui/model/notification/admin_notification.dart';
import 'package:soolmate_ui/model/notification/notify_like_user.dart';
import 'package:soolmate_ui/model/notification/on_off_anonymous.dart';
import 'package:soolmate_ui/model/notification/on_off_notification.dart';
import 'package:soolmate_ui/model/notification/on_off_show_me_map.dart';
import 'package:soolmate_ui/model/notification/user_notification.dart';
import 'package:soolmate_ui/model/report.dart';
import 'package:soolmate_ui/model/search/search_user.dart';
import 'package:soolmate_ui/model/search/search_user_by_id.dart';
import 'package:soolmate_ui/model/setting.dart';
import 'package:soolmate_ui/model/store_file_give_path.dart';
import 'package:soolmate_ui/model/update_saved_profile.dart';
import 'package:soolmate_ui/model/user/delete_account.dart';
import 'package:soolmate_ui/model/user/get_profile.dart';
import 'package:soolmate_ui/model/user/like_model.dart';
import 'package:soolmate_ui/model/user/registration_user.dart';
import 'package:soolmate_ui/model/user_block_list.dart';
import 'package:soolmate_ui/model/verification.dart';
import 'package:soolmate_ui/model/wallet/minus_coin_from_wallet.dart';
import 'package:soolmate_ui/service/firebase_notification_manager.dart';
...
import 'package:soolmate_ui/utils/pref_res.dart';
...
class ApiProvider {
  ...
  Future<AdminNotification> adminNotification(int start) async {
    http.Response response = await http
        .post(Uri.parse(Urls.aGetAdminNotification), headers: {
      Urls.apiKeyName: ConstRes.apiKey
    }, body: {
  ...
  Future<LikeModel> updateLikedProfile(int? profileId) async {
    ...
    List<String> profileList =
        likedProfile.isNotEmpty ? likedProfile.split(',').toList() : [];
  ...
  Future<Verification> applyForVerification(
    ...
    var request =
        http.MultipartRequest(Urls.post, Uri.parse(Urls.aApplyForVerification));
    request.headers.addAll({
      Urls.apiKeyName: ConstRes.apiKey,
    });
    request.fields[Urls.userId] = PrefService.userId.toString();
  ...
  Future<DeleteAccount> deleteAccount(int? deleteId) async {
    ...
    DeleteAccount deleteAccount =
        DeleteAccount.fromJson(jsonDecode(response.body));
  ...
  Future<SearchUser> fetchLikedProfiles() async {
    http.Response response = await http.post(
        ...
        headers: {Urls.apiKeyName: ConstRes.apiKey},
        body: {Urls.userId: '${PrefService.userId}'});
    return SearchUser.fromJson(jsonDecode(response.body));
  }
